			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding">
					<ul class="nav nav-pills nav-stacked">
                    	...
                    	<li class="active"><a href="<?=site_url('mensajeria/papelera'); ?>"><i class="fa fa-trash-o"></i> Papelera <? if ($nummpp>0){?><span class="label label-primary pull-right"><?=$nummpp?></span><? }?></a></li>
                  	</ul>
                </div><!-- /.box-body -->
			</div><!-- /. box -->
		</div><!-- /.col -->
		<div class="col-xs-9">
			<div class="box box-primary">
				<div class="box-header">
                  <h3 class="box-title">Papelera</h3>                  
                </div><!-- /.box-header -->
                <div class="box-body no-padding">                  
...
<div class="modal fade bs-example-modal-sm" id="recuperarmp" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header" style="background-color:red; color:#FFF">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">Recuperar mensaje</h4>
      		</div>
      		<div class="modal-body" id="body-elim"></div>
            <form action="<?=site_url('mensajeria/recuperarMPAjax'); ?>" method="post" accept-charset="utf-8"> 
                <input type="hidden" name="di" id="di" value="">
            <div class="modal-footer">
        		<button type="button" class="btn btn-danger btn-flat" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancelar</button> 
                <button type="submit"  class="btn btn-success btn-flat" id="confElimMP"><spam class='glyphicon glyphicon-ok' aria-hidden="true"></spam> Recuperar</button>
            </div> 
          </form>     		
    	</div>
  	</div>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
            ...
            <div class="modal-footer" id="footer-opc">
                ...
                <button type="button"  class="btn btn-danger btn-flat" data-dismiss="modal" data-toggle="modal" data-target="#recuperarmp" id="recuperarmp-opc"><i class="fa fa-inbox"></i> Recuperar</button>
            </div> 
    	</div>
  	</div>
</div>
...
function opcMP(di){	
	...
	$( "#recuperarmp-opc" ).click(function() {
		$('#body-elim').html('<h4 style="color:red;" align="center">¿Realmente desea enviar este mensaje a la bandeja de entrada?</h4>');	
