		...
		<div class="modal-content">
			<div class="modal-header" style="background-color:#3c8dbc; color:#FFF" id="header-ventanaObs"></div>
      			<div class="modal-body">         		
            		<form action="<?=site_url('observador/Observacion'); ?>" method="post" accept-charset="utf-8" id="newobs" name="newobs">
                    	<div class="form-group">
							<label class="control-label">Fecha</label>
                            <div class="input-append date" id="fecha_obs">
								<input type="text" class="form-control" id="nacimientoest" name="nacimientoest" value="" required><span class="add-on"><i class="splashy-calendar_day"></i></span>
							</div>
                        </div>     
                        <div class="form-group">
                    		<label class="control-label">Tipo de Observación</label>
                      		<input type="text" class="form-control" name="TObs" id="TObs" value="" disabled/> 
                  		</div>
                    	<div class="form-group">
                      		<label for="nombre">Descripción</label>
                        	<textarea class="form-control" rows="3" id="DesObs" name="DesObs" value="" required></textarea>
                    	</div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="guardarObs" data-dismiss="modal"><i class="fa fa-check"></i> Guardar</button><input type="hidden" name="idEst" id="idEst" value="" required> <input type="hidden" name="creadopor" id="creadopor" value="<?=$this->session->userdata('usuario');?>"><input type="hidden" name="creadoporid" id="creadoporid" value="<?=$this->session->userdata('di');?>" required><input type="hidden" name="process" id="process" value="" required>
		...
		<div class="modal-content">
			<div class="modal-header" style="background-color:red; color:#FFF" id="header-elimObs"></div>
             ...
             <form action="<?=site_url('observador/eoa'); ?>" method="post" accept-charset="utf-8"> 
                ...
                <input type="hidden" name="nomest" id="nomest" value="">
            <div class="modal-footer">
        		<button type="button" class="btn btn-danger btn-flat" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancelar</button> 
...
function ObsNew(tipo){	
	...
	$("#nacimientoest").val('');
  	$("#DesObs").val('');
	if (tipo==1){$("#TObs").val('Convivencia');}
	if (tipo==2){$("#TObs").val('Correctivo');} 
	if (tipo==3){$("#TObs").val('Estimulo');} 
	$('#observacion').modal('show');
}
