                	...
                	<div class="btn-group">
                    	<button type="button" class="btn btn-primary btn-flat dropdown-toggle" data-toggle="dropdown"><spam class='glyphicon glyphicon-cog'></spam> Acciones <span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>	
                      	<ul class="dropdown-menu" role="menu">
                        	<li><a href="#" data-toggle="modal" data-target="#est" onClick="crearEst();"><span class="glyphicon glyphicon-education" aria-hidden="true"></span> Nuevo Estudiante</a></li>						<li class="divider"></li>
                   ...
                   <table class="table table-bordered table-striped table-hover" id="estudiantes">
        			...
        			<tbody>
        				<? foreach($listest as $est):?>
          				<tr data-toggle="modal" data-target="#opc-est" id="<?=$est['identificacion']; ?>" onClick="opcEst('<?=$est['identificacion']; ?>','<?=$est['nombres']; ?>','<?=$est['apellidos']; ?>')">
                        	<td style="width:60px">
...
<div class="modal fade bs-example-modal-lg" id="est" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    								...
    								<div class="row setup-content" id="step-4">
    									...
    									<table width="100%" border="0">  
                                            ...
                                            <tr>
                                        		...
                                        		<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
                                            	<td align="right">
                                            		<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Guardar Estudiante</button>		<input type="hidden" name="foto2" id="foto2" value="" required><input type="hidden" name="process" id="process" value=""><input type="hidden" name="menu" id="menu" value="0" required>
                                            	</td>
                                       		</tr>
                                        </table>
    								</div>
...
<div class="modal fade bs-example-modal-sm" id="elim-est" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header" style="background-color:red; color:#FFF">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">Eliminar Estudiante</h4>
      		</div>
      		<div class="modal-body" id="body-elim"></div>
            <form action="<?=site_url('estudiantes/EliminarEstAjax'); ?>" method="post" accept-charset="utf-8"> 
            ...
            <div class="modal-footer">
                ...
                <button type="submit"  class="btn btn-success btn-flat" id="confElimEst"><spam class='glyphicon glyphicon-ok' aria-hidden="true"></spam> Eliminar</button>
            </div> 
          </form>     		
    	</div>
  	</div>
</div>
<div class="modal fade bs-example-modal-sm" id="opc-est" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header" style="background-color:#00A65A; color:#FFF" id="header-opc"></div>
      		<div class="modal-body" id="body-opc"></div>            
            <div class="modal-footer" id="footer-opc">
            	<button type="button" class="btn btn-success btn-flat" data-dismiss="modal"  data-toggle="modal" data-target="#est" id="edit-opc" value="edit-opc"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</button>
                <button type="button"  class="btn btn-danger btn-flat" data-dismiss="modal" data-toggle="modal" data-target="#elim-est" id="elim-opc" value="elim-opc"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Eliminar</button>
            </div> 
    	</div>
  	</div>
</div>
...
function crearEst(){
	...
	$("#colanterior").val("");	
	$("#asalud").val("");
	if($("input[name=nombreest]").val()==''){
		$('#header-ventana').html('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">Nuevo Estudiante</h4>');
	}
	$("input[name=apeest]").change(function(){
		var est = $('input[name="nombreest"]').val()+' '+$('input[name="apeest"]').val();
		if(est==''){
			$('#header-ventana').html('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">Nuevo Estudiante</h4>');
		}else{
			$('#header-ventana').html('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="myModalLabel">'+est+'</h4>');	
		}
	});
};

function opcEst(diest,nom,ape){	
	var di = diest;	
	$('#header-opc').html('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>	</button><h4 class="modal-title" id="myModalLabel"> '+nom+' '+ape+'</h4>');
	$('#body-opc').html('<h4 style="color:#060;" align="center">¿Qué desea hacer con el estudiante '+nom+' '+ape+'?</h4>');
	
	$( "#edit-opc" ).click(function() {
		$('input[name="process"]').val(2);
		if($('#foto2').html()==''){sayCheese2.start();}	
		$('#header-ventana').html('<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>				<h4 class="modal-title" id="myModalLabel">'+nom+' '+ape+'</h4>');	
		var info = { est: di };
		$.ajax({	
	...
	$( "#elim-opc" ).click(function() {
		$('#body-elim').html('<h4 style="color:red;" align="center">¿Realmente desea eliminar el estudiante '+nom+'?</h4>');	
